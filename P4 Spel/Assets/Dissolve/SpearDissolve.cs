...
public class SpearDissolve : MonoBehaviour {
    ...
    private void EndParticles()
    {
        if (!ended)
        {
            ...
            a.Play();
            a3.Play();
            lightning.gameObject.GetComponent<DigitalRuby.LightningBolt.LightningBoltScript>().Trigger();
            lightning2.gameObject.GetComponent<DigitalRuby.LightningBolt.LightningBoltScript>().Trigger();
            lightning3.gameObject.GetComponent<DigitalRuby.LightningBolt.LightningBoltScript>().Trigger();
