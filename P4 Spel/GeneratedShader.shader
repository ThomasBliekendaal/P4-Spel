	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "LightweightLighting.cginc"
							...
							float4 _PBRMaster_F7A79AE3_Albedo;
							float4 _PBRMaster_F7A79AE3_Normal;
							float4 _PBRMaster_F7A79AE3_Emission;
							float _PBRMaster_F7A79AE3_Metallic;
							float _PBRMaster_F7A79AE3_Smoothness;
							float _PBRMaster_F7A79AE3_Occlusion;
							float _PBRMaster_F7A79AE3_Alpha;
							GraphVertexInput PopulateVertexData(GraphVertexInput v){
								return v;
							}
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								SurfaceDescription surface = (SurfaceDescription)0;
								surface.Albedo = _PBRMaster_F7A79AE3_Albedo;
								surface.Normal = _PBRMaster_F7A79AE3_Normal;
								surface.Emission = _PBRMaster_F7A79AE3_Emission;
								surface.Metallic = _PBRMaster_F7A79AE3_Metallic;
								surface.Smoothness = _PBRMaster_F7A79AE3_Smoothness;
								surface.Occlusion = _PBRMaster_F7A79AE3_Occlusion;
								surface.Alpha = _PBRMaster_F7A79AE3_Alpha;
								return surface;
							}
